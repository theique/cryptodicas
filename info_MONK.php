<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width"><title>CRYPTODICAS - INFO MONK</title>
...
echo "<table><tr><td>";
echo "Olá ". $_SESSION['nome'] ." ". $_SESSION['sobrenome'] .", Informações sobre a MONK ";
echo "</td></tr></table><br>";
